...
const EditCompanyScreen = () => {
  ...
  const { curCompany, getOneCompany, isLoading, updateCompany } = useContext(BusinessContext)
    ...
    <UniContainer>
      ...
      <Form onSubmit={submitHandler}>
        ...
        <div className="d-grid gap-2">
          <Button type='submit' variant='primary' onClick={submitHandler} >Actualizar Datos</Button>
        </div>
      </Form>
